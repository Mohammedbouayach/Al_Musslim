            ...
            <div className="max-w-6xl mx-auto">
                ...
                <div className="mb-10 max-w-2xl mx-auto">
                    <div className="relative">
                        ...
                        <input
                            ...
                            className="w-full py-4 pr-10 pl-4 text-gray-700 dark:text-gray-200 bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-600 rounded-full focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-transparent shadow-sm transition-all"
                        />
                        {searchTerm && (
                            <button
                                onClick={clearSearch}
                ...
                {massage ? (
                    <div className="text-center py-16 bg-white dark:bg-gray-800 rounded-2xl shadow-lg max-w-2xl mx-auto">
                        ...
                        <button
                            onClick={clearSearch}
                            className="px-6 py-2 bg-orange-600 hover:bg-orange-700 text-white rounded-full transition-colors"
                        >
                            عرض الكل
                        </button>
                    </div>
                                ...
                                >
                                    <div className="p-6">
                                        <div className="flex items-center mb-4">
                                            <div className="flex-shrink-0 w-12 h-12 rounded-full bg-orange-100 dark:bg-orange-900/30 flex items-center justify-center ml-4">
                                                <FontAwesomeIcon
                                        ...
                                        <div className="mt-6 flex items-center justify-between">
                                            <span className="text-xs font-medium px-2.5 py-0.5 rounded-full bg-orange-100 text-orange-800 dark:bg-orange-900/30 dark:text-orange-300">
                                                قارئ
                                            </span>
