                        ...
                        <div
                            ...
                            <div className="p-6">
                                ...
                                <div className="flex flex-wrap gap-2 mb-4 text-sm">
                                    ...
                                    {/* <div className="flex items-center bg-orange-50 dark:bg-orange-900/30 text-orange-700 dark:text-orange-300 px-3 py-1 rounded-full">
                                        ...
                                        <div className="space-y-3">
                                            ...
                                            {item.attachments.map((attachment, key2) => (
                                                <a
                                                    ...
                                                    href={attachment.url}
                                                    download
                                                    className="flex items-center justify-between w-full px-4 py-3 bg-gradient-to-r from-orange-500 to-orange-600 hover:from-orange-600 hover:to-orange-700 text-white rounded-lg transition-all duration-300 hover:shadow-md">
                ...
                <div className="mt-12 flex flex-col sm:flex-row justify-between items-center gap-4">
                    {data.links.prev === "" ? (
                        ...
                        <Link
                            ...
                            className="flex items-center justify-center w-full sm:w-auto px-6 py-3 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg text-gray-700 dark:text-gray-300 hover:bg-orange-50 dark:hover:bg-orange-900/20 hover:border-orange-500 hover:text-orange-600 dark:hover:text-orange-400 transition-all duration-300">
