    ...
    return (
        <footer className="relative bg-gradient-to-b from-gray-50 to-gray-100 dark:from-gray-900 dark:to-gray-800 pt-16 pb-8 overflow-hidden">
            ...
            <div className="absolute inset-0 overflow-hidden pointer-events-none">
                <div className="absolute top-10 left-10 w-64 h-64 border-4 border-orange-200 dark:border-orange-900 rounded-full opacity-20 dark:opacity-10"></div>
                <div className="absolute bottom-20 right-10 w-48 h-48 border-4 border-orange-200 dark:border-orange-900 rounded-full opacity-20 dark:opacity-10"></div>
                <div className="absolute top-1/2 left-1/4 w-32 h-32 border-4 border-orange-200 dark:border-orange-900 transform rotate-45 opacity-20 dark:opacity-10"></div>
            </div>
            ...
            <div className="container mx-auto px-4 relative z-10">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
                    ...
                    <div className="transform transition-transform duration-300 hover:-translate-y-2">
                        <div className="flex items-center mb-6">
                            <Image
                                ...
                                className="mr-3"
                            />
                            {/* <h3 className="text-2xl font-bold text-orange-700 dark:text-orange-400">المسلم</h3> */}
                        </div>
                        ...
                        {/* <div className="bg-white dark:bg-gray-800 rounded-xl p-4 shadow-md">
                            ...
                            <form onSubmit={handleSubmit} className="flex">
                                <input
                                    ...
                                    className="flex-1 px-4 py-2 rounded-l-lg border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-700 text-gray-800 dark:text-white focus:outline-none focus:ring-2 focus:ring-orange-500"
                                    required
                                />
                                <button
                                    type="submit"
                    ...
                    {/* الروابط الأولى */}
                    <div className="transform transition-transform duration-300 hover:-translate-y-2">
                        <h3 className="text-lg font-bold text-gray-800 dark:text-white mb-6 pb-2 border-b-2 border-orange-600 dark:border-orange-500 inline-block">
                            الروابط الرئيسية
                        </h3>
                        <ul className="space-y-3">
                            {links1.map((item, index) => (
                                <li key={index}>
                                    <Link
                                        href={item.path}
                                        className="flex items-center text-gray-600 dark:text-gray-400 hover:text-orange-600 dark:hover:text-orange-400 transition-colors duration-300 group"
                                    >
                                        <FontAwesomeIcon
                                            icon={faAngleDoubleLeft}
                                            className="ml-2 text-xs opacity-0 group-hover:opacity-100 transition-opacity duration-300 text-orange-600 dark:text-orange-500"
                                        />
                                        <span>{item.name}</span>
                                    </Link>
                                </li>
                        ...
                        <div className="bg-white dark:bg-gray-800 rounded-2xl p-6 shadow-lg mb-6 border border-gray-100 dark:border-gray-700 hover:shadow-xl transition-all duration-300">
                            <div className="flex flex-col items-center text-center">
                                ...
                                <p className="text-gray-500 dark:text-gray-400 mb-4">
                                    مبرمج ويب | Full Stack Developer
                                </p>
                                ...
                                <div className="flex justify-center gap-3 mt-2">
                                    {socialLinks.map((social, index) => (
                                        <a
                                            ...
                                            className="w-10 h-10 rounded-full bg-gray-100 dark:bg-gray-700 flex items-center justify-center text-gray-600 dark:text-gray-300 hover:bg-orange-600 hover:text-white transition-colors duration-300"
                                        >
                ...
                <div className="border-t border-gray-200 dark:border-gray-700 pt-6 pb-4">
                    <div className="flex flex-col md:flex-row justify-between items-center">
                        <p className="text-gray-600 dark:text-gray-400 text-sm pb-4 md:mb-0">
                            ...
                            <span className="text-orange-600 dark:text-orange-500 font-bold mx-1"> لموقع المسلم  </span>
                        </p>
                        {/* <div className="flex space-x-4 rtl:space-x-reverse">
                            <Link href="/privacy" className="text-gray-600 dark:text-gray-400 hover:text-orange-600 dark:hover:text-orange-400 text-sm transition-colors duration-300">
                                سياسة الخصوصية
                            </Link>
                            <Link href="/terms" className="text-gray-600 dark:text-gray-400 hover:text-orange-600 dark:hover:text-orange-400 text-sm transition-colors duration-300">
                                الشروط والأحكام
                            </Link>
                        </div> */}
                    </div>
