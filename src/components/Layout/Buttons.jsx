        ...
        <>
                ...
                {showBtn && (
                    <motion.button
                        ...
                        className={`
                            ...
                            ${dark
                                ? "bg-gradient-to-tr from-gray-900 via-gray-800 to-gray-700 text-white hover:from-gray-800 hover:to-gray-600 focus:ring-orange-400"
                                : "bg-gradient-to-tr from-orange-400 via-orange-300 to-orange-200 text-gray-900 hover:from-orange-300 hover:to-orange-100 focus:ring-orange-500"
                            }
                        `}
                    >
            ...
            <motion.button
                ...
                className={`
                    ...
                    ${dark
                        ? "bg-gray-900 text-orange-300 hover:bg-gray-800 focus:ring-orange-400"
                        : "bg-orange-400 text-gray-900 hover:bg-orange-300 focus:ring-orange-500"
                    }
                `}
            >
                {dark ? (
