    ...
    return (
        <section className="relative dark:from-gray-900 dark:to-gray-800 py-24 mt-20">
            ...
            {/* <div className="absolute inset-0 pointer-events-none">
                ...
                <div className="absolute bottom-0 right-0 w-[500px] h-[500px] bg-orange-400/10 rounded-full blur-3xl translate-x-1/4 translate-y-1/4" />
            </div> */}
            ...
            <div className="relative z-10 container mx-auto px-6 text-center">
                ...
                <div className="flex justify-center items-center mt-8">
                    ...
                    <div className="mx-3 w-3 h-3 rounded-full bg-orange-500 shadow-sm"></div>
                    <div className="h-px bg-gray-300 dark:bg-gray-700 w-20"></div>
                </div>
            </div>
        </section>
