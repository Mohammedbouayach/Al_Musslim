...
const QuizApp = ({ quizSettings }) => {
    ...
    const getResultMessage = () => {
        if (scorePercentage >= 90) return { message: 'ممتاز!', emoji: '🏆', color: 'text-orange-600' };
        if (scorePercentage >= 70) return { message: 'جيد جداً!', emoji: '👍', color: 'text-orange-500' };
    ...
    return (
        <div className="container mx-auto px-4 py-8 max-w-4xl">
            ...
            <div className="mb-8 text-center">
                <h1 className="text-3xl md:text-4xl font-bold text-orange-700 dark:text-orange-400 mb-2">
                    أسئلة في {topic.name}
                </h1>
                <div className="inline-flex items-center bg-orange-100 dark:bg-orange-900/30 text-orange-800 dark:text-orange-300 px-4 py-2 rounded-full text-sm font-medium">
            ...
            {!showResults ? (
                ...
                >
                    <div className="p-6 md:p-8">
                        ...
                        <div className="mb-8">
                            <div className="flex items-center justify-center w-12 h-12 rounded-full bg-orange-100 dark:bg-orange-900/30 text-orange-600 dark:text-orange-400 mb-4 mx-auto">
                                        ...
                                        className={`p-4 md:p-5 rounded-xl text-lg font-quran text-right transition-all duration-300 flex items-start
                                            ${selectedAnswer !== null
                                                ? index === questions[currentQuestion].correctAnswer
                                                    ? 'bg-orange-100 dark:bg-orange-900/30 border-2 border-orange-500 text-orange-800 dark:text-orange-200'
                                                    : selectedAnswer === index
                                                        ? 'bg-red-100 dark:bg-red-900/30 border-2 border-red-500 text-red-800 dark:text-red-200'
                                                        : 'bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-300'
                                                : 'bg-white dark:bg-gray-700 border-2 border-gray-200 dark:border-gray-600 text-gray-800 dark:text-white hover:border-orange-400 hover:shadow-md'}
                ...
                >
                    <div className="p-8 text-center">
                        ...
                        <div className="w-full bg-gray-200 dark:bg-gray-700 rounded-full h-4 mb-8">
                            <motion.div
                                className="bg-gradient-to-r from-orange-500 to-teal-500 h-4 rounded-full"
                                initial={{ width: 0 }}
                        ...
                        <div className="flex flex-col sm:flex-row justify-center gap-4">
                            <motion.button
                                onClick={restartQuiz}
                                className="bg-orange-600 hover:bg-orange-700 text-white px-8 py-3 rounded-xl font-medium transition-colors flex items-center justify-center"
