    ...
    return (
        <section className="py-10 relative px-6 pt-28 bg-gradient-to-br from-gray-50 to-white dark:from-gray-900 dark:to-gray-800 min-h-screen">
            <div className="container mx-auto">
                <h2 className="text-3xl font-bold text-center mb-10 text-orange-700 dark:text-orange-400">
                    الأحاديث النبوية
                </h2>
                    ...
                    {data.data.map((item, index) => (
                        ...
                        >
                            <Link
                                ...
                                className="block group overflow-hidden relative bg-white dark:bg-gray-800 rounded-2xl border border-gray-200 dark:border-gray-700 shadow-md hover:shadow-lg hover:border-orange-400 transition-all duration-300 p-5"
                            >
                                <div className="flex flex-col justify-between h-full">
                                    <div>
                                        <h3 className="text-lg font-semibold text-gray-800 dark:text-gray-100 mb-3 leading-relaxed group-hover:text-orange-600 dark:group-hover:text-orange-400 transition-colors duration-200">
                                            {item.title}
                                        </h3>
                                        {item.explanation && (
                                    ...
                                    <div className="flex items-center justify-between mt-4 text-sm text-gray-500 dark:text-gray-400">
                                        ...
                                        <div className="flex items-center gap-1 group-hover:text-orange-600 dark:group-hover:text-orange-400 transition-colors">
                                            <span>اقرأ</span>
