...
export default function Adith({ id }) {
    ...
    if (isLoading) {
        return (
            <section className="py-16 px-4 bg-gradient-to-br from-white to-orange-50 dark:from-gray-900 dark:to-gray-800 min-h-screen flex items-center justify-center">
        ...
        <section className="py-12 md:py-16 px-4 min-h-screen">
            ...
            <div className="container mx-auto relative max-w-4xl">
                ...
                <motion.div
                    ...
                    className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl overflow-hidden mb-8 border border-orange-100 dark:border-gray-700"
                >
                    <div className="p-6 md:p-8">
                        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-6">
                            <div className="flex items-center">
                                {/* <div className="w-10 h-10 rounded-full bg-orange-100 dark:bg-orange-900/30 flex items-center justify-center ml-3">
                ...
                <motion.div
                    ...
                    className="bg-gradient-to-r from-orange-50 to-white dark:from-gray-800 dark:to-gray-900 rounded-2xl shadow-xl p-6 md:p-8 mb-8 border border-orange-100 dark:border-gray-700 relative overflow-hidden"
                >
                    ...
                    <div className="relative z-10">
                        <div className="flex items-center mb-4">
                            {/* <div className="w-8 h-8 rounded-full bg-orange-600 flex items-center justify-center ml-3">
                                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-white" viewBox="0 0 20 20" fill="currentColor">
                                    <path fillRule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7-4a1 1 0 11-2 0 1 1 0 012 0zM9 9a1 1 0 000 2v3a1 1 0 001 1h1a1 1 0 100-2v-3a1 1 0 00-1-1H9z" clipRule="evenodd" />
                                </svg>
                            </div> */}
                            <h3 className="text-xl font-bold text-orange-800 dark:text-orange-400">نص الحديث</h3>
                        </div>

                        <div className="text-xl md:text-2xl text-gray-800 dark:text-white leading-relaxed bg-white/70 dark:bg-gray-800/50 p-6 rounded-xl border border-orange-100 dark:border-gray-700">
                            {data.hadeeth}
                        </div>
                    </div>
                </motion.div>
                ...
                <motion.div
                    ...
                    className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-6 md:p-8 mb-8 border border-orange-100 dark:border-gray-700"
                >
                    <div className="flex items-center mb-4">
                ...
                <motion.div
                    ...
                    className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-6 md:p-8 border border-orange-100 dark:border-gray-700"
                >
                    <div className="flex items-center mb-4">
