...
export default function AuthorQuotes({ params }) {
    ...
    const showData = filterData.map((item, index) => (
        <div
            ...
            <div className="h-1 bg-gradient-to-r border-orange-500 to-teal-400"></div>

            <div className="p-6 md:p-8">
                <div className="flex justify-center mb-5">
                    <div className="relative">
                        <div className="absolute inset-0 bg-gradient-to-r border-orange-400 to-teal-500 rounded-full opacity-70"></div>
                ...
                <blockquote className="text-center">
                    ...
                    <div className="flex items-center justify-center space-x-2">
                        ...
                        <cite className="text-lg font-semibold text-orange-600 dark:text-orange-400 not-italic">
                            {item.author}
                        </cite>
                        <div className="h-px bg-gradient-to-r from-transparent via-orange-400 to-transparent w-16"></div>
                    </div>
            ...
            <div className="bg-gray-50 dark:bg-gray-900/50 px-6 py-4 flex justify-center items-center gap-4">
                <button
                    ...
                    className="flex items-center justify-center w-12 h-12 rounded-full bg-white dark:bg-gray-800 text-orange-600 dark:text-orange-400 border border-orange-200 dark:border-orange-900 hover:bg-orange-50 dark:hover:bg-orange-900/30 hover:text-orange-700 dark:hover:text-orange-300 transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-orange-500 focus:ring-opacity-50"
                ...
                <button
                    ...
                    className={`flex items-center justify-center w-12 h-12 rounded-full bg-white dark:bg-gray-800 ${savedQuotes.includes(item.id) ? 'text-orange-600 dark:text-orange-400' : 'text-gray-500 dark:text-gray-400'} border border-orange-200 dark:border-orange-900 hover:bg-orange-50 dark:hover:bg-orange-900/30 hover:text-orange-700 dark:hover:text-orange-300 transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-orange-500 focus:ring-opacity-50`}
    ...
    return (
        <>
            {/* <Landing
                ...
                className="bg-gradient-to-br from-orange-50 to-teal-50 dark:from-gray-900 dark:to-gray-800"
            /> */}
            <ToastContainer
                theme="colored"
            ...
            />
            <section className="py-12 relative mt-20 px-4 bg-gradient-to-b from-orange-50/50 to-white dark:from-gray-900/50 dark:to-gray-900">
