                                    ...
                                    <div className="p-4 flex-grow flex flex-col">
                                        ...
                                        {item.attachments.length > 0 && (
                                            <button
                                                ...
                                                className="mt-auto flex items-center justify-center w-full py-2.5 px-4 bg-gradient-to-r from-orange-600 to-teal-500 hover:from-orange-700 hover:to-teal-600 text-white text-sm font-medium rounded-lg transition-all duration-300 transform hover:scale-[1.02] active:scale-[0.98]"
                                            >
                                            ...
                                            <div key={index} className="flex items-center justify-between p-3 bg-gray-50 dark:bg-gray-700 rounded-lg">
                                                ...
                                                <div className="flex space-x-2 gap-3">
                                                    ...
                                                    <button
                                                        ...
                                                        className="p-2 bg-orange-700 w-10 h-10 text-white rounded-lg transition-colors"
                                                        title="تحميل"
                                                    >
