            ...
            <section className="pt-5 pb-20 container px-3 m-auto">
                <div className="flex items-center justify-between mb-8">
                    <h2 className="text-3xl font-bold text-gray-800 dark:text-white flex items-center">
                        <FontAwesomeIcon icon={faBook} className="ml-3 text-orange-600 text-2xl" />
                        المكتبة الإسلامية
                    </h2>
                        ...
                        >
                            ...
                            <div className="flex flex-col flex-grow p-5">
                                <a href={item.attachments[0]?.url || '#'} className="block">
                                    <h3 className="text-lg font-bold text-gray-900 dark:text-white mb-2 line-clamp-2 hover:text-orange-600 transition-colors">
                                        {item.title}
                                    </h3>
                                </a>
                                ...
                                <div className="mt-auto space-y-3">
                                    ...
                                    <div className="flex justify-between text-sm">
                                        <div className="flex items-center text-gray-600 dark:text-gray-400">
                                            <FontAwesomeIcon icon={faFileAlt} className="ml-2 text-orange-500" />
                                            <span className="font-medium">الحجم:</span>
                                            <span className="mr-2">{item.attachments[0]?.size || 'غير محدد'}</span>
                                        </div>

                                        <div className="flex items-center text-gray-600 dark:text-gray-400">
                                            <FontAwesomeIcon icon={faCalendar} className="ml-2 text-orange-500" />
