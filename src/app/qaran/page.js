                        ...
                        <div className="group relative overflow-hidden rounded-2xl bg-white dark:bg-gray-800 shadow-xl hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2">
                            <div className="relative h-80 md:h-96 overflow-hidden">
                                ...
                                <div className="absolute bottom-0 left-0 right-0 p-6 text-white">
                                    ...
                                    <p className="text-orange-100">استمع لتلاوات القرآن الكريم بمجموعة متنوعة من الشيوخ</p>
                                </div>
                            </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-10">
                            <div className="bg-white dark:bg-gray-800 p-6 rounded-xl shadow-md">
                                <div className="w-12 h-12 bg-orange-100 dark:bg-orange-900/30 rounded-full flex items-center justify-center mx-auto mb-4">
                                    <FontAwesomeIcon icon={faHeadphonesSimple} className="text-orange-600 dark:text-orange-400 text-xl" />
                                </div>
