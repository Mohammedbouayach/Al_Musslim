                ...
                <div className="grid grid-cols-2 gap-2 mt-4">
                    {item.attachments?.map((attachment, key2) => (
                        <a
                            ...
                            href={attachment.url}
                            download
                            className="flex items-center justify-center px-3 py-2 text-sm font-medium text-white bg-gradient-to-r from-orange-500 to-teal-500 rounded-lg hover:opacity-90 transition-opacity"
                        >
