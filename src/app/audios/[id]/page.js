...
const getImportanceColor = (level) => {
    return level === 'high' ? 'bg-red-500' : 'bg-orange-500';
};
        ...
        >
            ...
            <div className="relative h-48 overflow-hidden">
                {item.image ? (
                    ...
                    <div className="absolute inset-0 flex items-center justify-center bg-gradient-to-br from-orange-500 to-orange-700">
            ...
            <div className="p-6">
                ...
                <a href={item.attachments?.[0]?.url || '#'} className="block mb-3">
                    <h5 className="text-xl font-bold text-gray-900 dark:text-white group-hover:text-orange-600 dark:group-hover:text-orange-400 transition-colors">
                        {item.title}
                    </h5>
                </a>
                ...
                <div className="grid grid-cols-2 gap-2 mt-4">
                    {item.attachments?.map((attachment, key2) => (
                        <a
                            ...
                            href={attachment.url}
                            download
                            className="flex items-center justify-center px-3 py-2 text-sm font-medium text-white bg-gradient-to-r from-orange-500 to-orange-500 rounded-lg hover:opacity-90 transition-opacity"
                        >
            ...
            <div className="px-6 pb-4 flex gap-2">
                <Link
                    ...
                    className="flex-1 flex items-center justify-center py-3 text-sm font-medium text-center text-white bg-gradient-to-r from-orange-600 to-orange-600 rounded-lg hover:opacity-90 transition-opacity"
                >
                ...
                <a
                    ...
                    download
                    className="flex items-center justify-center px-4 py-3 text-sm font-medium text-center text-white bg-gradient-to-r from-orange-600 to-orange-500 rounded-lg hover:opacity-90 transition-opacity"
                >
                ...
                <div className="mt-10 flex justify-between items-center">
                    {links.prev === "" ? (
                        ...
                        <Link
                            ...
                            className="flex items-center justify-center w-32 py-3 px-4 bg-gray-100 dark:bg-gray-800 rounded-lg hover:bg-orange-100 dark:hover:bg-orange-900 transition-colors group"
                        >
                            <FontAwesomeIcon
                                className="ml-2 text-gray-600 dark:text-gray-300 group-hover:text-orange-600"
                                icon={faAngleDoubleRight}
                            />
                            <span className="font-medium text-gray-700 dark:text-gray-300 group-hover:text-orange-600">السابق</span>
                        </Link>
                    )}
                    ...
                    {links.next === "" ? (
                        ...
                        <Link
                            ...
                            className="flex items-center justify-center w-32 py-3 px-4 bg-gray-100 dark:bg-gray-800 rounded-lg hover:bg-orange-100 dark:hover:bg-orange-900 transition-colors group"
                        >
                            <span className="font-medium text-gray-700 dark:text-gray-300 group-hover:text-orange-600">التالي</span>
                            <FontAwesomeIcon
                                className="mr-2 text-gray-600 dark:text-gray-300 group-hover:text-orange-600"
