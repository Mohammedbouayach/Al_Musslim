...
const getImportanceColor = (level) => {
    return level === "high"
        ...
        : { bg: "bg-gradient-to-r from-orange-500 to-orange-500", text: "عادية", icon: "" };
};
                                    ...
                                    >
                                        <div className="relative h-48 overflow-hidden">
                                            {audio.image ? (
                                                ...
                                                <div className="absolute inset-0 flex items-center justify-center bg-gradient-to-br from-orange-600 to-orange-800">
                                        ...
                                        <div className="p-4">
                                            ...
                                            <div className="flex items-center text-xs text-gray-500 dark:text-gray-400 mb-2">
                                                <FontAwesomeIcon icon={faUser} className="ml-2 text-orange-500" />
                                                <span>{audio.prepared_by[0]?.title || "غير محدد"}</span>
                                            </div>

                                            <div className="flex items-center text-xs text-gray-500 dark:text-gray-400 mb-3">
                                                <FontAwesomeIcon icon={faCalendarAlt} className="ml-2 text-orange-500" />
                                                <span>{formatDate(audio.add_date)}</span>
                                            </div>

                                            <div className="flex items-center text-xs text-gray-500 dark:text-gray-400 mb-4">
                                                <FontAwesomeIcon icon={faFileAudio} className="ml-2 text-orange-500" />
                                                ...
                                                {audio.attachments?.map((att, index) => (
                                                    <div key={index} className="flex items-center justify-between p-3 bg-gray-50 dark:bg-gray-700 rounded-lg">
                                                        <div className="flex items-center">
                                                            <FontAwesomeIcon icon={faVolumeUp} className="text-orange-500 ml-2" />
                        ...
                        <div className="flex justify-center items-center gap-4 mt-12 mb-6">
                            <button
                                ...
                                className={`flex items-center px-5 py-3 rounded-xl font-medium transition-all ${
                                    links?.prev
                                        ? "bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 hover:bg-orange-50 dark:hover:bg-orange-900/20 text-gray-800 dark:text-gray-200 hover:text-orange-600 dark:hover:text-orange-400 shadow-sm"
                    ...
                    >
                        ...
                        >
                            <div className="p-6">
                                ...
                                <div className="mb-6 bg-gradient-to-r from-orange-500 to-orange-600 rounded-xl p-8 flex items-center justify-center">
                                    <FontAwesomeIcon icon={faHeadphones} className="text-6xl text-white/80" />
                                </div>
