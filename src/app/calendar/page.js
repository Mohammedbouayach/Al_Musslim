                    ...
                    <div className="flex flex-col md:flex-row justify-between items-center gap-6">
                        ...
                        <div className="bg-white/10 p-4 rounded-lg backdrop-blur-sm">
                            <div className="text-center">
                                ...
                                <div className="mt-2 text-sm text-orange-100">{moment().format('dddd، D MMMM YYYY')}</div>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <table className="w-full whitespace-nowrap">
                    ...
                    <tbody className="divide-y divide-gray-200 dark:divide-gray-700">
                        {prayerTimes.map((day, i) => (
                            <tr key={i}
                                className={`${day.isLast10 ? 'bg-yellow-400 hover:bg-yellow-300 dark:hover:bg-yellow-300 text-white' : 'hover:bg-orange-50 dark:hover:bg-gray-800'}`}>
