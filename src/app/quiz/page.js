            ...
            return (
                <div className="space-y-8">
                    <div className="text-center mb-6">
                        <h2 className="text-3xl font-bold text-orange-700 mb-2">اختر القسم</h2>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        {data?.mainCategories.map((category) => (
                            ...
                            >
                                <div className="absolute inset-0 bg-gradient-to-r from-orange-500 to-teal-500 opacity-0 group-hover:opacity-5 transition-opacity"></div>
                                <div className="p-6">
                                    <div className="flex items-center mb-4">
                                        <div className="w-12 h-12 rounded-lg bg-orange-100 dark:bg-orange-900/30 flex items-center justify-center ml-4">
                                            <span className="text-orange-600 dark:text-orange-400 font-bold">{category.id}</span>
                                        </div>
                                        <h3 className="text-xl font-bold text-orange-800 dark:text-white">{category.arabicName}</h3>
                                    </div>
                                    <p className="text-gray-600 dark:text-gray-300 text-sm">{category.description}</p>
                                    <div className="mt-4 flex items-center text-sm text-orange-600 dark:text-orange-400 font-medium">
                                        <span>اختر الآن</span>
            ...
            return (
                <div className="space-y-8">
                    <div className="flex items-center justify-between mb-6">
                        <div>
                            <h2 className="text-3xl font-bold text-orange-700 mb-2">اختر الموضوع</h2>
                            ...
                            >
                                ...
                                <div className="p-6">
                                    <div className="flex items-center mb-3">
                                        <div className="w-10 h-10 rounded-lg bg-orange-100 dark:bg-orange-900/30 flex items-center justify-center ml-3">
                                        ...
                                        <h3 className="text-lg font-bold text-orange-800 dark:text-white">{topic.name}</h3>
                                    </div>
        ...
        if (!quizSettings.difficulty) {
            return (
                <div className="space-y-8">
                    <div className="flex items-center justify-between mb-6">
                        <div>
                            <h2 className="text-3xl font-bold text-orange-700 mb-2">اختر مستوى الصعوبة</h2>
