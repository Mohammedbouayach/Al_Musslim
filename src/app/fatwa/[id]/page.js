        ...
        >
            ...
            <div className="px-6 pb-4">
                <a
                    ...
                    download
                    className="w-full flex items-center justify-center py-3 text-sm font-medium text-center text-white bg-gradient-to-r from-orange-600 to-orange-600 rounded-lg hover:opacity-90 transition-opacity"
                >
